        ...
        while True:
            ...
            if time.time() - last_shot_taken > 2:
                ...
                if frame:
                    ...
                    # scan QR codes
                    self.routine_flow(frame)
                time.sleep(0.5)


    def routine_flow(self, frame):
